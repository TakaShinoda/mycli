...
(0, ava_1.default)("greet unknown user", (t) => {
    ...
    t.is(lastFrame(), (0, chalk_1.default) `Hello, I'm {green Stranger}`);
});
(0, ava_1.default)("greet user with a name", (t) => {
    const { lastFrame } = (0, ink_testing_library_1.render)(react_1.default.createElement(ui_1.default, { guest: "Jane" }));
    t.is(lastFrame(), (0, chalk_1.default) `Hello, I'm {green Jane}`);
});
